						...
						<div class="col-sm-6 col-lg-4 mb-4">
							<div class="card h-100">
								...
								<div class="card-body">
									...
									<?php 
									if ($speaker != '') : ?>
										<p class="card-text"><img src="<?php echo site_url(); ?>/wp-content/themes/cygnature/images/employee.svg" alt="navigation right" /> <?php echo rtrim(trim($speaker), '|'); ?></p>
									<?php endif; ?>
									
								</div>
								<div class="card-footer bg-transparent border-top-0">
									<a href="<?php the_permalink(); ?>" class="read-more-link" title="Register for Webinar">Register Now <img src="<?php echo site_url(); ?>/wp-content/themes/cygnature/images/Iconfeather-arrow-right.svg" alt="navigation right" /></a>
								</div>
							</div>
						</div>
					<?php endwhile;

...
jQuery(window).scroll(function() {    
  ...
  setTimeout(function() {
   ...
   jQuery('.top-tab .top-tab-main-section .top-tab-inner a').click(function(){
       jQuery('.modal .icon-box').css("visibility", "visible !important");
  });
  jQuery('.top-tab .top-tab-main-section .top-tab-inner').addClass('show-floter');
  setTimeout(function() {
    jQuery('.top-tab .top-tab-main-section .top-tab-inner').removeClass('show-floter');
  }, 5000);

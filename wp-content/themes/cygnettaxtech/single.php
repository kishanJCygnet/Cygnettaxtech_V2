                            ...
                            <div class="single-container">
                                ...
                                <div class="container">
									<div class="article-container">
										<div class="row">
											<div class="<?php if (get_field('show_sidebar') == 'Yes') : ?><?php else: ?><?php endif; ?> container-with-sidebar mb-5 mb-md-0">
												...
												<aside class="sidebar">
													...
													<div class="sidebar-block-body">
														<?php //echo do_shortcode('[contact-form-7 id="41345" title="Blog detail page contact form"]'); ?>
														<?php echo do_shortcode('[contact-form-7 id="39212" title="Blog detail page contact form"]'); ?>
													</div>
												</aside>
											</div>
										</div>
